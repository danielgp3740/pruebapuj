                          ...
                          <div class="col-md-6">
                           ...
                           <div class="col-md-6">
                               ...
                               <label>Observaciones</label>
                                  <textarea id="txt_observaciones" style="height:80px;" name="txt_observaciones" data-msg-required="Por favor ingrese la información de las observaciones." class='required' readonly></textarea>
