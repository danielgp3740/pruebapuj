...
$textlethg=strlen($nombre_sismenu);
if($textlethg > 29){
	$estiloleght='style="float:left; margin-left:24px; margin-top:-24px"';
}
else{
	$estiloleght='';
}
      ...
      ?>
        <?php echo $beginmostrar; ?>
            <li>
                <a href="<?php echo $enlace_menu; ?>"><img src="<?php echo $sys_imagen; ?>" /> <span class="title" <?php echo $estiloleght; ?> ><?php echo $nombre_sismenu; ?></span>
                  <?php
