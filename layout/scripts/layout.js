...
$(document).ready(function(){
	function alturaDentro(){
		var alto_dentro = $(window).height() - 300;
		var alto_content = $(window).height() - 79;

		//alert(alto_dentro);
		$(".dentro").css({ 'height': alto_dentro+'px' });
		$(".page-content-wrapper .page-content").attr('style', 'min-height:' + alto_content + 'px');
		//$(".dentro").animate({'height':( alto_dentro+'px')},50);
	}
