...
<style>
/*****************************************************************
**Estilos del modal para los programas del sector administrativo**
******************************************************************/
.modal-dialog{
    position:absolute;
    top: 30px;
  ...
  #ModalErrorMP .modal-dialog , #ModalErrorMunicipio .modal-dialog, #ModalErrorVigencia .modal-dialog, #ModalErrorFifu .modal-dialog, #ModalErrorGenero .modal-dialog{
    width: 30%;
...
<div class="page-container">
    ...
    <!-- INICIO MODAL erroFuentesFinaciación-->
    <div class="modal fade" id="ModalErrorFufi" role="dialog">
      <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-body">
            <p><h2>Debe Digitar Datos en Fuentes de Financiación</h2></p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">ACEPTAR</button>
          </div>
    ...
    <!-- INICIO MODAL erroFuentesFinaciación-->
    <div class="modal fade" id="ModalErrorPogenero" role="dialog">
      <div class="modal-dialog">
        <!-- Modal content-->
        <div class="modal-content">
          <div class="modal-body">
            <p><h2>Debe Digitar Datos en Población por Genero</h2></p>
          </div>
          <div class="modal-footer">
            <button type="button" class="btn btn-default" data-dismiss="modal">ACEPTAR</button>
          </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                  ...
                                  <select id="sel_vigencia" name="sel_vigencia" title="Seleccione la vigencia" required="" aria-required="true" class="valid" aria-invalid="false">
                                      ...
                                      <option value="<?php echo $fre_vigencia; ?>"><?php echo $fre_fechareporte; ?></option>
                                  </select>
