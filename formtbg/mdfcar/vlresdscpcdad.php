        ...
        <div id="titulo" class="titulo">
             ...
             <div class="bloDr">
               ...
               ?>
                 ...
                 <input type="button" onclick="modificar_discapacidad();" value='' class="guardar-modal" alt="Guardar" title="Guardar">
               <?php
                 }
              ?>
...
<script type='text/javascript'>
      ...
      function modificar_discapacidad(){
					var data_enviar=$('.frm_vejecutadodiscapacidad').serialize();
						$.post("modificarvaloresdiscapacidad",data_enviar,
