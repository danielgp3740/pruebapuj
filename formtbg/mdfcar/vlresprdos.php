...
$mpr_indicadorsgi=$data_valormp['mpr_indicadorsgi'];
$mpr_formulaindsgi=$data_valormp['mpr_formulaindsgi'];
...
$data_modificarvaloresejecucion=$cnxn_pag->obtener_filas($datos_modificarvaloresejecucion);
    ...
    $vej_fechacreo=$data_modificarvaloresejecucion['vej_fechacreo'];
    $vej_municipio=$data_modificarvaloresejecucion['vej_municipio'];
    ...
    $vej_entidad=$data_modificarvaloresejecucion['vej_entidad'];
    $vej_numerador=$data_modificarvaloresejecucion['vej_numerador'];
    $vej_denominador=$data_modificarvaloresejecucion['vej_denominador'];
      ...
      <div id="titulo" class="titulo">
           Modificar Valores Avance Ejecución
             <div class="bloDr">
               ...
               ?>
           <!-- Fecha a reportar: <?php echo $fre_fechaperiodo; ?> -->
        ...
        <br>
         ...
         <div class="col-md-12">
           ...
           <div class="col-md-4">
             ...
             <input type="number" step="0.001" id="txt_numerador" name="txt_numerador" data-rule-required="true" data-rule-number="true" data-msg-required="Por favor ingrese el dato." data-msg-number="Por favor ingrese un número." value="<?php echo $vej_numerador;  ?>" required />
           </div>
           <div class="col-md-4">
             <label>Denominador</label>
             <input type="number" step="0.001" id="txt_denominador" name="txt_denominador" data-rule-required="true" data-rule-number="true" data-msg-required="Por favor ingrese el dato." data-msg-number="Por favor ingrese un número." value="<?php echo $vej_denominador; ?>" required />
           </div>
         </div>
         <?php
           }
           ...
           <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <label>Contrato / Convenio / Acta / Fecha</label>
                   <textarea id="txt_observaciones" style="height:80px;" name="txt_observaciones" data-msg-required="Por favor ingrese la información de las observaciones." class='required'><?php echo $vej_observacion; ?></textarea>
             ...
             <input type="hidden" name="txt_metaproducto" id="txt_metaproducto" value="<?php echo $vej_metaproducto; ?>" />
             <input type="hidden" name="txt_vigencia" id="txt_vigencia" value="<?php echo $vej_vigencia; ?>" />
             <input type="hidden" name="txt_personac" id="txt_personac" value="<?php echo $vej_personacreo; ?>" />
             <input type="hidden" name="txt_fechac" id="txt_fechac" value="<?php echo $vej_fechacreo; ?>" />
             <input type="hidden" name="txt_municipio" id="txt_municipio" value="<?php echo $vej_municipio; ?>" />
             <input type="hidden" name="txt_entidad" id="txt_entidad" value="<?php echo $vej_entidad; ?>" />
...
/*
    ...
    */
    ...
    function modificar_valorejecutado(){
        var data_enviar=$('.frm_vejecutadomodificar').serialize();
          $.post("prcs_modificarvalorejecucion",data_enviar,
