             ...
             Valores Población Etnica
               <div class="bloDr">
                 ...
                 ?>
                   ...
                   <input type="button" onclick="modificar_etnia();" value='' class="guardar-modal" alt="Guardar" title="Guardar">
                 <?php
                   }
                ?>
...
*/
      function modificar_etnia(){
					var data_enviar=$('.frm_vejecutadoetnia').serialize();
						$.post("modificarvaloresetnia",data_enviar,
