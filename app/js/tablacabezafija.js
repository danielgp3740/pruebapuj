 ...
 * Requires: jquery.1.3+
 *
jQuery.fn.tablacabezafija = function (options) {

    console.log("tablacabezafija---");
    ...
    $(".dentro").scroll(function(){
        ...
        $tbl.find("thead").css({
            "position": "fixed",
            "width": tablaAncho,
            "top":  $tbl.offset().top-settings.espacio,
...
jQuery.fn.tablacabezafija = function (options) {
    ...
    this.each(function (i) {
        ...
        if ($tblhfixed.find(headerelement).length > 0) {
            ...
            //console.log("espacio: " + settings.espacio);
