...
$sql_seccion="SELECT * FROM seccion";
...
<script type="application/javascript">
		tinymce.init({
			...
			/* 
			relative_urls:true,
			external_filemanager_path:"/mialegria2014/filemanager/",
			filemanager_title:"Administrador de Archivos" ,
			external_plugins: { "filemanager" : "/mialegria2014/filemanager/plugin.min.js"}
...
<div id="wrap">
	...
	<div id="content-wrap">
	  ...
	  <div id="content">
			...
			<form name="frm_contenido" action="proceso_contenido.php" method="post" class="forma">			
				<p>			
				...
				<select name="selSubseccion" id="selSubseccion">
				  ...
				  if($_REQUEST['codigo_contenido']){
				  	$sql_subseccion="SELECT sse_codigo, sse_nombre 
									 FROM subseccion
									 WHERE sec_codigo=".$seccion_conte." ";
                ...
                <label>Introducci&oacute;n</label>
                	<textarea rows="20" cols="55" name="intro" id="txtintro"><?php echo $intro_contenido; ?></textarea>
               <br /><br />
                <label>Contenido</label>
               	<textarea rows="20" cols="55" name="textototal" id="txtcontenido"><?php echo $total_contenido; ?></textarea>
