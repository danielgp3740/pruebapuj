...
$base_url ="http://".$_SERVER['HTTP_HOST']; //.$_SERVER['HTTP_HOST'];  // DON'T TOUCH (base url (only domain) of site (without final /)).
$upload_dir = '/alyesko/source/'; // path from base_url to base of upload folder (with start and final /)
