...
<tr class="bg-v">
  ...
  <th class="wd-15">&nbsp;
    <strong>
      V 2016
      <a href='excelreportexescenario?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2016; ?>'> <img src='img/excel_icono.png' alt='Generar Excel 1' title="Generar Excel 1"></a>
      <a href='excelreporteexcelavance?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2016; ?>'><img src='img/excel_icono.png' alt='Generar Excel 2' title="Generar Excel 2"></a>
    </strong>
  </th>
  <th class="wd-15">&nbsp;
    <strong>
      V 2017
      <a href='excelreportexescenario?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2017; ?>'><img src='img/excel_icono.png' alt='Generar Excel 1' title="Generar Excel 1"></a>
      <a href='excelreporteexcelavance?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2017; ?>'><img src='img/excel_icono.png' alt='Generar Excel 2' title="Generar Excel 2"></a>
    </strong>&nbsp;
  </th>
  <th class="wd-15">&nbsp;
    <strong>
      V 2018
      <a href='excelreportexescenario?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2018; ?>'><img src='img/excel_icono.png' alt='Generar Excel' title="Generar Excel 1"></a>
      <a href='excelreporteexcelavance?<?php echo $codigo_escenarioadmin; ?>-<?php echo $codigo_entidadtbg; ?>-<?php echo 2018; ?>'><img src='img/excel_icono.png' alt='Generar Excel' title="Generar Excel 2"></a>
...
<?php
  ...
  $ent_codigo=$data_listampxescenario['ent_codigo'];
...
?>
  <tr>
    ...
    $valoracumuladovigencias=0;
      while($data_valoresperado=$cnxn_pag->obtener_filas($valor_esperadomp)){
        ...
        //$color_semaforomp = $semaforomepro->semaforomp($cnxn_pag, $ves_vigencia, $codigoentidad, $ves_metaproducto, $valor_esperado);
          if($ent_codigo==12){
            list($valorpromedio_semaforo, $letro_logro, $colorcirculo_semaforo, $colorvigencia, $entrovalore)=$semaforomepro->semaforompsalud($cnxn_pag, $ves_vigencia, $codigoentidad, $ves_metaproducto, $ves_valor,$mpr_valorcuatrenio, $mpr_tendenciapositiva, $mpr_lineabase, $tipometaproducto);
          }
          else{
      ...
      switch ($tipoorientacion) {
        ...
        case 'LBMV4':
            ...
            if($mpr_valorcuatrenio==0 && $valoracumuladoejecutado==0){
              ...
              if($mpr_tendenciapositiva=='1'){
                $cumplimientovigencias=$valorpromedio_semaforo;//number_format(($valoracumuladoejecutado/$totalesperadometa)*100 , 2, '.', '');
              }
              elseif($mpr_tendenciapositiva=='2') {
                if($valoracumuladoejecutado==0){
                  ...
                  $cumplimientovigencias=$valorpromedio_semaforo;//number_format(($totalesperadometa/$valoracumuladoejecutado)*100 , 2, '.', '');
                }
              }
            }
    ...
    <td class="tdEspe acumulado-v wd-15">
        ...
        <span class="colEspe">Esperado: </span><span> <?php echo $totalesperadometa; ?></span>
        <span class="colEspe">Acumulado: </span><span>&nbsp;<?php echo $valoracumuladoejecutado; ?>  <?php //echo $tipoorientacion;  ?></span>
...
<tr>
  <td colspan="9" class="m-barra wd-20"  >
    <?php
    for ($yearvigencia=2016; $yearvigencia <= 2018; $yearvigencia++) {
    ?>
      <div class="barras">
