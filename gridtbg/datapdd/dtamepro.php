...
<table class="tablaFijaCss">
       ...
       $numeroregistro=1;
        while($data_metaproducto=$cnxn_pag->obtener_filas($meta_productoentidad)){
            ...
            $mpr_indicadorsgi=$data_metaproducto['mpr_indicadorsgi'];
            $mpr_formulaindsgi=$data_metaproducto['mpr_formulaindsgi'];

            if($data_metaproducto['mpr_indicadorsgi']==''){
              $mpr_indicadorsgi='NA';
            }

            if($data_metaproducto['mpr_formulaindsgi']==''){
              $mpr_formulaindsgi='NA';
            }
...
*/
        ...
        <tr>
          ...
          <td width="15.1%" style=" text-align: left"><?php echo $pro_codigo." - ".$pro_nombre; ?></td>
          <td width="25.1%" style=" text-align: left">
            <p>
              <strong>Descripción: </strong> <?php echo $mpr_codigo." - ".$mpr_descripcion; ?>
            </p>

            <p>
              <strong>Nombre Indicador SGI: </strong> <?php echo $mpr_indicadorsgi; ?>
            </p>

            <p>
              <strong>Formula Indicador SGI: </strong> <?php echo $mpr_formulaindsgi; ?>
            </p>
