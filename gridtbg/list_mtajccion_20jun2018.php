      ...
      <thead>
        ...
        <thead data-codigomp="<?php echo $mpr_codigo; ?>">
          <tr class="trdato"  <?php echo $color; ?>  >
              ...
              <td data-label="Valor Cuatrenio"><?php echo $mpr_valorcuatrenio; ?></td>
              <td data-label="Fotos" class="noB"><a class="fotos_metaproducto" title="" href="Javascript:void(0);" data-codigometaproducto='<?php echo $mpr_codigo; ?>'><img src="img/ico/imagen.png" /></a></td>
...
<script type='text/javascript'>
        ...
        $(".fotos_metaproducto").click(function(){
            var codigo_metaproducto = $(this).data("codigometaproducto");
            //alert(codigo_metaproducto);
            $.ajax({
              url:"lista_fotosmetaproducto",
              type:"POST",
              data:"codigo_metaproducto="+codigo_metaproducto,
              async:true,
